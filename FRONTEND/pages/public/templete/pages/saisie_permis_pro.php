...
$id_mt=htmlspecialchars($_SESSION['id_mt']) ;
...
<input class="text" type="hidden" name="id_pro_cond_fk" value="<?php echo ($aff2['id_pro'])?>">
<input class="text" type="hidden" name="nom_pro_cond_fk" value="<?php echo ($aff2['nom_pro'])?>"> 
<input class="text" type="hidden" name="postnom_pro_cond_fk" value="<?php echo ($aff2['postnom_pro'])?>">
<input class="text" type="hidden" name="prenom_pro_cond_fk" value="<?php echo ($aff2['prenom_pro'])?>">
