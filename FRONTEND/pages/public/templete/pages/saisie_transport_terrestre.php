...
<div class="row">
  <h3>SAISIE MOYEN DE TRANSPORT</h3>
  
    <div class="col-lg-6">
      <a href="?p=dashboard_operateur"><button class="btn btn-outline btn-primary">TABLEAU DE BORD</button></a><br><br>
            ...
            <div class="col-lg-12">
              ...
              <?php while ($aff=mysqli_fetch_assoc($res)){?>
                <div class="alert alert-success" role="alert">
                  ...
                  <p>Le moyen de transport <strong><?php echo ($aff['id_mt'])?></strong> a été enregistré avec succès, pour poursuivre les processus d’identification du moyen de transport cliquez sur    
                 
                  <p class="mb-0"><a href="?p=apercu_moyen_de_transport&&id_mt=<?php echo ($aff['id_mt']) ?>"><button type="submit" name="Poursuivre" class="btn btn-primary">Poursuivre</button></a></p></p>
                </div>
                ...
                <p> <strong>NUM CHASSIS: </strong><?php echo ($aff['num_chassis_mt'])?></p>
                <p> <strong>NUM MOTEUR: </strong><?php echo ($aff['num_moteur_mt'])?></p>
                <p> <strong>TYPE: </strong><?php echo ($aff['type_mt'])?></p>
                <p> <strong>POSITION VOLANT: </strong><?php echo ($aff['main_mt'])?></p>
