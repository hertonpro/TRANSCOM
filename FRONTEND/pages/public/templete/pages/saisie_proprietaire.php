...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="page-header">
            <h4>PROPRIETAIRE DE MOYEN DE TRANSPORT NUMERO:<strong><?php echo ($_GET['id_mt'])?></strong></h4>
                            <div class="input-group custom-search-form" >
                 <form  method="GET" action="chercher_proprietaire_affect.php">
                        <div class="input-group custom-search-form">
                        <input id="search-input" name="recherche_nom_pro"  placeholder="Recherche..." placeholder="chercher conducteur"  type="text" class="form-control" >
    ...
    <h2 class="mb-4">APERCU GENERAL PROPRIETAIRE</h2>
...
<br>
<a href="?p=affectation_pro&&id_pro=<?php echo ($aff['id_pro'])?>"><button > Aller affecter le proprietaire </button></a>
   <hr>
      <?php }?>
</div>            