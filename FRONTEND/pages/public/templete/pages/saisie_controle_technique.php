          ...
          <!-- /.panel-heading -->
            <div class="panel-body">
              <?php
                ...
                Reff CTT: <?php echo ($aff['reff_controle_technique'])?><br>
                Date de livraison: <?php echo ($aff['date_livraison_controle_technique'])?><br>
                Date d'expiration: <?php echo ($aff['date_expiration_controle_technique'])?><br>
                ...
                if($rest_jours>=0){
                  ...
                  echo $alerte='<strong>'.'<p class="">'."Le controle technique reste avec ". $rest_jours.' Jour(s)'.'</p>'.'</strong>';
                }

                elseif($rest_jours<0){
                  echo $alerte='<strong>'.'<p class="blue" >'."Le controle technique a expiré il y a ".$rest_jours.' Jour(s)'. '</p>'.'<strong>';
                }
              ?>
              <hr class="two">
              <?php }?>
