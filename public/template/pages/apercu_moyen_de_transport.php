<div class="row">
    ...
    <div class="page-header">
        <h4> MOYEN DE TRANSPORT(<strong>234221-SKV</strong>)</h4>
    </div>
        <div class="panel panel-default">
            <div class="panel-heading">Réferences</div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <p> <strong>Numero de plaque: </strong>BKV-3453-AA</p>
                <p> <strong>Modele : </strong>vehicule</p>
                <p> <strong>Marque: </strong>rav4</p>
                <p> <strong>Annee de fabrication: </strong>2004</p>
                <p> <strong>Numero de chassis: </strong>gde-44665643-34343nff</p>
                <p> <strong>Numero moteur: </strong>456744-45TY</p>
                <p> <strong>Position de volant: </strong>main gauche</p>
                <p> <strong>Clouleur: </strong>Grise</p>
            </div>
            <br>
            <div class="panel-heading">Proprietaire <a class="text-danger">+Plus</a></div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <p> <strong>Proprietair: </strong>BKV-3453-AA</p>
                <p> <strong>Dâte d'apropriation : </strong>23-04-2005</p>
                <p> <strong>Marque: </strong>rav4</p>
                <p> <strong>Annee de fabrication: </strong>2004</p>
                <p> <strong>Numero de chassis: </strong>gde-44665643-34343nff</p>
                <p> <strong>Numero moteur: </strong>456744-45TY</p>
    ...
    <div class="col-lg-6">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <img src="../images/rav4.png" alt="..." class="img-thumbnail">
                <br><br>
            <div class="row">
