            ...
            <div class="form-group">
              <form method="POST" action="" enctype="multipart/form-data" accept-charset="utf-8">
                <label>Radio Buttons</label>
                  <div class="radio">
                    <label>
                      <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>Vehicule ou moto volé
                    </label>
                    <label>
                      <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>Accidenté
                    </label>
                    <label>
                      <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>Fouille la PCR
                    </label>
                    <label>
                      <input type="radio" name="optionsRadios" id="optionsRadios1" value="option1" checked>Autres degats routier
                    </label>
                  </div>
                  <div class="form-group">autre_alerte
                  ...
                  <div class="form-group">Dossier
                    <input class="form-control" value="non reglé" type="text" name="casier_mt">
                  </div>
